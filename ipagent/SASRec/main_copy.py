...
def train(args, model_dir, Log_file, Log_screen, start_time, local_rank):
    ...
    if 'epoch' in args.load_ckpt_name:
        ...
        start_epoch = 39
        # ckpt_path = '/data2/tencent/MicroLens/Code/VideoRec/SASRec/checkpoint/checkpoint_MicroLens-100k_pairs_with_cold_text/cpt_v1_sasrec_blocknum_2_tau_0.07_bs_256_ed_512_lr_0.0001_l2_0.1_flrText_5e-05_bert-base-chinese_freeze_165_maxLen_10/epoch-104.pt'
