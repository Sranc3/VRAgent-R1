...
tag = 'MicroLens-100k'
behaviors = tag + '_pairs_colduser.tsv'
text_data = tag + 'complete_copy.csv'
image_data = tag + '_covers.lmdb'
video_data = tag + '_ks_fi5_fn5_frames.lmdb'
frame_no = 5
max_seq_len_list = [10]
...
image_model_load = 'vit-b-32-clip' # 'vit-b-32-clip' swin_tiny vit-base-mae
video_model_load = 'video-mae' # video-mae

# last 2 layer of trms
text_freeze_paras_before = 165
image_freeze_paras_before = 164 #183 for swin, 164 for mae, 45 for resnet
...
epoch = 50
# load_ckpt_name = 'None'
load_ckpt_name = 'epoch-34.pt' # epoch-33.pt
        ...
        for max_seq_len in max_seq_len_list:
            for index in index_list:
                ...
                run_py = "CUDA_VISIBLE_DEVICES='0,1,2,3' \
                        ...
                        --nproc_per_node 4 --master_port 34567 main.py \
