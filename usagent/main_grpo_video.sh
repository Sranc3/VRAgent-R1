...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/data2/RL/data/processed/microlens_video_preference/train.parquet \
    data.val_files=/data2/RL/data/processed/microlens_video_preference/test.parquet \
    ...
    trainer.project_name='GRPO_logic_video' \
    trainer.experiment_name='Qwen-7B' \
    trainer.n_gpus_per_node=4 \
    trainer.nnodes=1 \
    trainer.default_local_dir='/data2/RL' \
