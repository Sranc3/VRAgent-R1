...
# 指定输出目录
OUTPUT_DIR="outputs/video_like_grpo"
mkdir -p $OUTPUT_DIR
...
python -m verl.trainer.main_ppo \
    ...
    data.train_files=/data2/RL/data/processed/steam_like_rl/train.parquet \
    data.val_files=/data2/RL/data/processed/steam_like_rl/test.parquet \
    ...
    trainer.experiment_name=video_like_structured \
    trainer.logger=[] \
    trainer.nnodes=1 \
    ...
    trainer.default_local_dir=./checkpoints/verl_examples/steam_like \
